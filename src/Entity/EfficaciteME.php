...
/**
 * @ORM\Entity(repositoryClass="App\Repository\EfficaciteMERepository")
 */
class EfficaciteME
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="efficacite_m_e")
     */
    private $user;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Opinion", inversedBy="efficacitemes")
     */
    private $opinion;
